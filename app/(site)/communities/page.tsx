...
export default async function CommunitiesPage() {
  if (!supabaseConfigured()) {
    return <p className="mt-10 text-center text-sm text-mist">Communities open once Supabase is configured. See the README.</p>;
  }
  ...
  return (
    <>
      <h1 className="text-2xl font-semibold tracking-tight text-shell">Communities</h1>
