...
test.describe("signed in", () => {
  ...
  // phase4.spec.ts owns the tally itself, the profile endorsement, and the database refusing anyone
  // but the organizer. This covers what it leaves out: the tally surviving a reload, and what a
  // volunteer sees on the same page.
  test("a saved tally survives a reload, and a volunteer sees the total without the controls", async ({ page }) => {
    ...
    // The volunteer sees the public total, and none of the organizer's controls.
